...
public class MappingPacienteImpl implements MappingPaciente {
    ...
    protected ConsultaResponse consultaToConsultaResponse(Consulta consulta) {
        if ( consulta == null ) {
            return null;
        }
        ...
        paciente = toPAcienteResponse( consulta.getPaciente() );
    ...
    protected List<ConsultaResponse> consultaListToConsultaResponseList(List<Consulta> list) {
        ...
        for ( Consulta consulta : list ) {
            list1.add( consultaToConsultaResponse( consulta ) );
        }
